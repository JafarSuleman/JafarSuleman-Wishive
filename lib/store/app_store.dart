...
import 'package:socialv/whv/language/whv_app_localizations.dart';
...
abstract class AppStoreBase with Store {
  ...
  Future<void> setLanguage(String aCode, {BuildContext? context}) async {
    ...
    // WHV
    whvLanguage = await WhvAppLocalizations().load(Locale(selectedLanguage));
  }

  @observable
  int mainScreenSelectedTabIndex = 0;

  late TabController tabController;

  @action
  initializeTabController(TabController newTabController) {
    tabController = newTabController;
  }

  @action
  updateSelectedTab(int index) {
    mainScreenSelectedTabIndex = index;
  }
}
