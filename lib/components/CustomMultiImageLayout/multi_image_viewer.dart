...
class MultiImageViewer extends StatelessWidget {
  const MultiImageViewer({
    ...
    this.onImagePressed,
    this.openImageInFullScreen = false,
  ...
  /// To get Image click call back
  final bool openImageInFullScreen;
  /// To get Image click call back
    ...
    switch (images.length) {
      ...
      case 1:
        return GestureDetector(
          onTap: () => openImage(
              context, 0, imagesList, captionList, networkImageHeaders, onImagePressed),
          child: Container(
            height: height,
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: GestureDetector(
                  onTap: () => openImage(
                      context, 1, imagesList, captionList, networkImageHeaders, onImagePressed),
                  child: Container(
                    height: height,
                    width: width == null ? defaultWidth / 2 : width! / 2,
                    decoration: BoxDecoration(
          ...
          child: Row(children: [
                    ...
                    child: Padding(
                      ...
                      child: GestureDetector(
                        onTap: () => openImage(context, 0, imagesList,
                            captionList, networkImageHeaders, onImagePressed),
                        child: Container(
                          decoration: BoxDecoration(
                              color: backgroundColor,
                              image: DecorationImage(
            ...
            Expanded(
              child: Padding(
                ...
                child: GestureDetector(
                  onTap: () => openImage(
                      context, 2, imagesList, captionList, networkImageHeaders, onImagePressed),
                  child: Container(
                    width: width == null ? defaultWidth / 2 : width! / 2,
                    decoration: BoxDecoration(
                        color: backgroundColor,
