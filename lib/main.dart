...
import 'package:socialv/whv/stores/whv_bookmarks_store.dart';
import 'package:socialv/whv/stores/whv_calendar_store.dart';
import 'package:socialv/whv/stores/whv_group_store.dart';
import 'package:socialv/whv/stores/whv_history_store.dart';
import 'package:socialv/whv/stores/whv_live_shoppable_store.dart';
import 'package:socialv/whv/stores/whv_tabs_store.dart';
import 'package:socialv/whv/stores/whv_shop_webview_store.dart';
import 'package:socialv/whv/stores/whv_trending_product_detail_store.dart';

import 'whv/stores/whv_add_to_wishlist_store.dart';
import 'whv/stores/whv_app_store.dart';
...
// WHV
WhvShopWebviewStore webviewStore = WhvShopWebviewStore();
WhvTrendingProductDetailWebView whvTrendingProductDetailWebViewStore =
    WhvTrendingProductDetailWebView();
WhvTabsStore tabsStore = WhvTabsStore();
WhvHistoryStore historyStore = WhvHistoryStore();
WhvBookmarksStore boomarksStore = WhvBookmarksStore();
WhvLiveShoppableStore liveShoppableStore = WhvLiveShoppableStore();
WhvGroupStore groupStore = WhvGroupStore();
WhvAddToWishlistStore addToWishlistStore = WhvAddToWishlistStore();
WhvCalendarStore whvCalendarStore = WhvCalendarStore();
WhvAppStore whvAppStore = WhvAppStore();

late BaseLanguage language;

// WHV
late WhvBaseLanguage whvLanguage;
