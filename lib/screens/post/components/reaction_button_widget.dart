...
class ReactionButton extends StatefulWidget {
  ...
  ReactionButton({this.isReacted,this.iconColor, required this.isComments, this.currentUserReaction, this.onReacted, this.onReactionRemoved});
        ...
        return FlutterReactionButton(
          ...
          initialReaction: Reaction(
            icon: cachedImage(
              ...
              width: size(),
              height: size(),
              color: widget.iconColor ?? context.iconColor,
              fit: BoxFit.cover,
            ),
          ),
