...
import 'package:socialv/screens/post/components/common_bottom_sheet.dart';
...
import 'package:socialv/whv/screens/wishlists/whv_wishes_list_vertical_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (!isPostHidden) {
      return GestureDetector(
        onTap: widget.post.mediaType.validate ()== MediaTypes.photo ? null : () {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    PostContentComponent(
                      postContent: widget.post.wishTitle,
                    ...
                    if(widget.post.wishListComment.validate().isNotEmpty)
                      Text(
                        widget.post.wishListComment.validate(),
                    ...
                    PostMediaComponent(
                      ...
                      onTapOfImage: (int index){
                        WhvWishesListVerticalViewScreen(wishPost: widget.post, navigateToWishId: widget.post.medias?[index].id ?? 0,)
