...
class CommentReplyScreen extends StatefulWidget {
  ...
  final bool initialTextFieldFocus;

  const CommentReplyScreen({required this.comment,required this.fromPostDetailsScreen, required this.postId, this.callback, this.openInBottomSheet = false, this.initialTextFieldFocus = false});

  @override
  State<CommentReplyScreen> createState() => _CommentReplyScreenState();
}

class _CommentReplyScreenState extends State<CommentReplyScreen>with TickerProviderStateMixin {
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          AppTextField(
                            focus: commentFocus,
                            autoFocus: widget.initialTextFieldFocus,
