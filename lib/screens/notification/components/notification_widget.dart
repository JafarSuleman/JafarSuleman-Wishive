...
import 'package:socialv/whv/components/notification/whv_wishlist_notification_component.dart';
import 'package:socialv/whv/screens/wishlists/whv_wish_view.dart';
import 'package:socialv/screens/membership/screens/membership_plans_screen.dart';
...
class NotificationWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // WHV - Notification for wishlists that have newly been created
    else if (notificationModel.action == WhvNotificationAction.whvWishlistCreatedAction) {
      return WhvWishlistNotificationComponent(
        element: notificationModel,
        callback: () {
          callback.call();
        },
      ).onTap(() async {
        WhvWishScreen(wishListId: notificationModel.secondaryItemId.validate()).launch(context);
      });
    }
    else {
      return Offstage();
