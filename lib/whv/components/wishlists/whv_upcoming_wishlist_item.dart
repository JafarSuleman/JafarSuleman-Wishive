...
import 'package:socialv/whv/models/wishlists/whv_upcoming_wishlist_model.dart';

import 'package:socialv/whv/screens/wishlists/whv_wish_screen.dart';
import 'package:socialv/whv/utils/whv_images.dart';

class WhvUpcomingWishlistItem extends StatelessWidget {
  const WhvUpcomingWishlistItem({
    super.key,
    required this.wishlistModel,
  });

  final WhvUpcomingWishlistModel wishlistModel;
