...
class WhvWishlistNotificationComponent extends StatelessWidget {
  final NotificationModel element;
  final VoidCallback? callback;

  WhvWishlistNotificationComponent({required this.element, this.callback});
              ...
              children: [
                RichText(
                  text: TextSpan(
                    children: [
                      WidgetSpan(
                        child: Text('${element.itemName.validate()} ',
                                style: boldTextStyle(
                                    size: 14, fontFamily: fontFamily))
                            .onTap(() {
                          MemberProfileScreen(
                                  memberId: element.itemId.validate())
                              .launch(context);
                        },
                      ...
                      if (element.isUserVerified.validate())
                        WidgetSpan(
                            child: Image.asset(ic_tick_filled,
                                ...
                                fit: BoxFit.cover)),
                      TextSpan(
                          text: whvLanguage.newWishlistCreated,
