...
class WhvOrdersScreen extends StatefulWidget {
  const WhvOrdersScreen({
  ...
  @override
  State<WhvOrdersScreen> createState() => _WhvOrdersScreenState();
}

class _WhvOrdersScreenState extends State<WhvOrdersScreen> {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: Scaffold(
        appBar: widget.showFullScreen == false
            ? null
            : AppBar(
                leading: IconButton(
