...
part 'whv_trending_product_detail_store.g.dart';

class WhvTrendingProductDetailWebView = _WhvTrendingProductDetailWebViewBase
    with _$WhvTrendingProductDetailWebView;

abstract class _WhvTrendingProductDetailWebViewBase with Store {
  @observable
  ...
  @observable
  bool isExpendFloatingButoon = true;

  @observable
  bool isExpendFlotingBtnMenu = false;
  ...
  @action
  changeStateOfFloatingButton({bool state = true}) {
    isExpendFloatingButoon = state;
  }

  @action
  changeStateOfFloatingButtonMenuExpend({bool state = true}) {
    isExpendFlotingBtnMenu = state;
  }
